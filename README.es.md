...
- 🗄️ **Base de Datos Automática**: ¿No tiene MariaDB instalado? El software se encarga de eso por usted en segundo plano, configurando todo en su máquina.
- 🇪🇸 **Totalmente en Español**: Interfaz intuitiva y soporte completo para el idioma español.
...
3. Ejecute el instalador y siga los 5 pasos guiados.
